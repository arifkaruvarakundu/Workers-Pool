...
function UserList() {
  ...
  const fetchData = (page = 1) => {
    axiosInstance.get(`userlist/?page=${page}&search=${searchQuery}`)
      .then(response => {
  ...
  const handleSearch = () => {
    // Trigger a search when the button is clicked or when the input field changes
  ...
  return (
    ...
    <div className='w-2/12'>
      <h3 className='font-bold text-3xl text-white '>USERS LIST</h3>
    </div>
